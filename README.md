...
https://miniclinic-https://github.com/luchiaowei/miniclinic.git.onrender.com
...
```bash
git clone https://github.com/https://github.com/luchiaowei/miniclinic.git/miniclinic.git
cd miniclinic
