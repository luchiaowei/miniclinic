...
('TEST0001', '測試病患甲', '男', '1985-03-15', '0912-345-678'),
('TEST0002', '王小明',     '男', '1990-07-22', '0923-456-789'),
('TEST0003', '李小華',     '男', '1978-11-30', '0934-567-890');

--初始掛號資料(appt_id必須明確指定，INSERT OR IGNORE 才能防止重複，見13.4說明)
INSERT OR IGNORE INTO appointment (appt_id, chart_no, doctor_id, appt_date, time_slot, status) VALUES
('1', 'TEST0001', 'D001', '2026-05-01', 'AM', 'BOOKED'),
('2', 'TEST0002', 'D002', '2026-05-01', 'AM', 'BOOKED'),
('3', 'TEST0003', 'D003', '2026-05-02', 'PM', 'BOOKED');